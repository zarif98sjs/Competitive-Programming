...
struct Graph
{
    ...
    Graph(int n,bool dir)
    {
        ...
        /// like mo
        cnt = vector<int>(len);
        cnt_cnt = vector<int>(len);
        cnt_cnt_val = vector<LL>(len);
    ...
    void add(int u,int p)
    {
        ...
        cnt[val] ++;
        cnt_cnt[cnt[val]]++;
        cnt_cnt_val[cnt[val]] += val;
        mx_ans = max(mx_ans,cnt[val]);
