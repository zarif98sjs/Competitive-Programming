...
First Learn : Query(l,r,k) : number of integers less than k in the range [l,r]
Use that idea to use Binary Search in this problem
...
int main()
{
    ...
    while(q--)
    {
        ...
        while(lo<hi)
        {
            ...
            int p = query(1,1,n,l,r,mid);

//            DBG(lo) , DBG(hi) , DBG(mid) , DBG(p);
